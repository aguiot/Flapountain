...
void main() {
	...
	vec3 diffuseColor = fragment.position[1]*vec3(0.f,0.f,1.f);
	vec3 specularColor = fragment.position[1]*vec3(0.f,0.f,1.f);

	Color = vec4(directionalLight(n, v, diffuseColor, specularColor, uSpecularPower),0.6f); 
